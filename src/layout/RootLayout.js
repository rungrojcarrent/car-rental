...
export default function RootLayout() {
  return (
    <>
      <Header />
      {/* ⚡ Bolt: Added Suspense boundary to handle lazy-loaded route components */}
      <Suspense fallback={<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '60vh', fontSize: '1.5rem', fontWeight: 'bold' }}>Loading...</div>}>
        <Outlet />
      </Suspense>
      <Footer />
      ...
      <div style={{
        ...
        <div className="social-icon" style={{
          ...
          <a href="https://www.youtube.com/@RungrojCarRental" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://www.facebook.com/RungrojCarRental/" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://www.tiktok.com/@RungrojCarRental" target="_blank" rel="noopener noreferrer">
