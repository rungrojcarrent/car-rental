...
export default function RootLayout() {
  return (
    <>
      <Header />
      {/* ⚡ Bolt: Added Suspense boundary to support lazy-loaded route components */}
      <Suspense fallback={<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '50vh', fontSize: '1.5rem' }}>กำลังโหลดข้อมูล...</div>}>
        <Outlet />
      </Suspense>
      <Footer />
